  ...
  return (
    ...
    >
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <svg className="absolute top-12 left-8 opacity-10 w-40 h-40 md:w-52 md:h-52 text-maroon" viewBox="0 0 200 200" fill="none">
        ...
        <svg className="absolute bottom-12 right-8 opacity-10 w-48 h-48 md:w-72 md:h-72 text-gold" viewBox="0 0 200 200" fill="none">
          <circle cx="100" cy="100" r="90" stroke="currentColor" strokeWidth="1"/>
      ...
      <div className="relative z-10 text-center px-4 w-full max-w-5xl mx-auto" style={{ animation: 'fadeInUp 1s ease forwards' }}>
        ...
        <h1 className="font-serif text-5xl md:text-8xl text-maroon leading-tight mb-3">Sur Pravaah</h1>
        <p className="font-serif italic text-xl md:text-3xl text-maroon/60 mb-8 px-2">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center px-4">
          <a href="#classes" className="inline-block px-8 py-4 bg-maroon text-cream font-sans text-sm tracking-widest uppercase hover:bg-maroon-light transition-all duration-300 hover:shadow-lg hover:shadow-maroon/20 hover:-translate-y-0.5">
            Explore Classes
          </a>
          <a href="#contact" className="inline-block px-8 py-4 border border-maroon text-maroon font-sans text-sm tracking-widest uppercase hover:bg-maroon hover:text-cream transition-all duration-300 hover:-translate-y-0.5">
            Contact Us
          </a>
        </div>
      </div>
