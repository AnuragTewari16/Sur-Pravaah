...
export default function Classes() {
  return (
    <section id="classes" className="py-28 px-6 md:px-12" style={{ background: '#F8F3EA' }}>
      <div className="max-w-screen-xl mx-auto">
        <div className="text-center mb-16">
          <p className="font-sans text-xs tracking-[0.3em] text-gold uppercase mb-4">What We Teach</p>
          <h2 className="font-serif text-5xl md:text-6xl text-maroon mb-6">Classes Offered</h2>
            ...
            <div key={cat.category} className="relative bg-parchment border border-gold/20 overflow-hidden group hover:border-gold/40 transition-all duration-500 hover:shadow-lg hover:shadow-maroon/5">
              ...
              <div className="p-10">
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <div>
                    <h3 className="font-serif text-2xl text-maroon">{cat.category}</h3>
                ...
                <div className="space-y-6">
                  {cat.classes.map((cls) => (
                    <div key={cls.name} className="flex gap-4">
                      ...
                      <div>
                        <h4 className="font-serif text-xl text-maroon mb-1">{cls.name}</h4>
                        <p className="font-body text-base text-maroon/60 leading-relaxed">{cls.desc}</p>
                      </div>
                    </div>
                  ))}
                </div>
        ...
        <div className="text-center mt-10">
          <p className="font-body text-lg text-maroon/60">
